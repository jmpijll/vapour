...
export interface InterfaceInfo {
  ...
  wifi?: {
    ...
    value: {
      status: string; link_quality_percent: number | null; phy_type: string | null;
      is_mlo_connection: boolean | null;
      links: {link_id: number; center_frequency_khz: number; bandwidth_raw: number; bandwidth_unit: string; rssi_dbm: number}[];
    } | null;
  } | null;
  route_configuration_status?: "pending" | "available" | "not_available" | "stale" | "query_failed";
  route_configuration?: {
  ...
  ip_configuration_status?: "pending" | "available" | "not_available" | "stale" | "query_failed";
  ip_configuration?: {
